...
public class EdenAIClient {
    ...
    public static void main(String[] args) {
        String s = "Artificial Intelligence (AI) is revolutionizing various industries, from healthcare to finance. AI-powered systems are capable of performing tasks that traditionally required human intelligence, such as visual perception, speech recognition, decision-making, and language translation. In healthcare, AI is being used to improve diagnostic accuracy and personalize treatment plans. For instance, machine learning algorithms can analyze medical images to detect diseases like cancer at an early stage, significantly improving patient outcomes. AI also plays a crucial role in drug discovery, accelerating the process of identifying potential new medications.  The finance sector is leveraging AI for fraud detection, algorithmic trading, and risk management. AI systems can process vast amounts of data in real-time to identify suspicious transactions and prevent fraud. Additionally, AI-driven trading algorithms can analyze market trends and execute trades at optimal times, maximizing returns for investors.";
